...
public class CookingView extends SelectionBaseView{
	private List<String> datas;	
	
	public CookingView(Context context, OptionData data, boolean operationEnable, Handler handler, boolean showInMainScreen) {
