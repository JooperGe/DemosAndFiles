...
public class HttpsSSLSocketFactory extends SSLSocketFactory {
	...
	public HttpsSSLSocketFactory(KeyStore truststore)
	...
	public static HttpClient createMyHttpClient(int connectionTimeOut, int soTimeOut) {
		try {
			KeyStore trustStore = KeyStore.getInstance(KeyStore
					.getDefaultType());
			trustStore.load(null, null);

			SSLSocketFactory mSSLSocketFactory = new HttpsSSLSocketFactory(
					trustStore);
			mSSLSocketFactory
