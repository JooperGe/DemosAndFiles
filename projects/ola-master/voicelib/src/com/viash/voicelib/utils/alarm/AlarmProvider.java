...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.viash.voice_assistant.db", "alarm", ALARMS);
        sURLMatcher.addURI("com.viash.voice_assistant.db", "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE alarms (" +
                       ...
                       "enabled INTEGER, " +
                       "vibrate INTEGER, " +
                       "message TEXT,"+"remindtime TEXT,"+"tab INTEGER);");
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        if (ret == null) {
            if (true) Log.v("Spencer", "Alarms.query: failed");
        } else {
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        Log.v("Spencer", "*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        Log.v("Spencer", "Added alarm rowId = " + rowId);
